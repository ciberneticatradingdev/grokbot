...
export async function maybeConsolidate(summarize) {
  ...
  try {
    ...
    const text = await summarize({
      system: "You maintain the long-term memory of grokbot, an autonomous streamer agent. Merge the OLD ARCHIVE with the NEW EVENTS into at most 500 words. Keep: launched coins and their CAs, promises made to the community, follower names and running jokes, market moments, tools it built, mistakes and lessons. Drop routine ticks and noise. Write in first person as grokbot's own memory.",
