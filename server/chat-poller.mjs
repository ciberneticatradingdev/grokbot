// chat-poller.mjs — pump.fun chat + comments for grokbot's coin.
...
const USERNAME = process.env.PUMP_CHAT_USERNAME || "grokbot";
const ME = new Set([USERNAME.toLowerCase(), "grokbot"]);
...
const isHuman = (u) => u && !ME.has(String(u).toLowerCase()) && !String(u).toLowerCase().startsWith("grokbot");
